        ...
        <article>
            <div class="col-50">
                ...
                <div class="search-result">
                    <a href="#">
                        <h3>Kunst</h3>
                        <p>De identiteit van Edam-Volendam ligt enerzijds in het zichtbare erfgoed en anderzijds in de
                            sterk gevoelde eigen identiteit binnen zowel de Volendamse als de Edamse bevolking. </p>
                    </a>
                </div>
                <div class="search-result">
                    <a href="#">
